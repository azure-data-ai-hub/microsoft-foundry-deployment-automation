...
| 3 | Onboard new models through configuration-driven processes | Add a model entry to a `.bicepparam` file; no Bicep module code changes required. Retirement is the same file edit plus an explicit opt-in prune | `docs/architecture.md` §5/§5.1/§5.2, `docs/deployment-guide.md` §5/§5.1, `docs/model-lifecycle-demo.md` |
